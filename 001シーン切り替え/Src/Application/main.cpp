...
void Application::DrawSprite()
{
	...
	{
		//ポリモーフィズム（多態性）
		//同じ関数でオブジェクトごとに異なる動作すること
		//m_nowScene->Draw();
		SceneManager::Instansce().Draw();
...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "シーン切り替え", "Window") == false) {
